...
class L02S04(Scene):
    def construct(self):
        ...
        coor_sys_liq_prov = Axes(x_range=[ 0.01, 10, 2 ], y_range=[ 0, 10, 2 ], x_length=2, y_length=2, tips=False,
        ...
        coor_sys_trader = Axes(x_range=[ 0, 10, 2 ], y_range=[ 0, 10, 2 ], x_length=2, y_length=2, tips=True,
                               y_axis_config={"include_numbers": False, 'include_tip': True, 'include_ticks': False, 'tip_width': 0.1,
                                              'tip_height': 5},
                               x_axis_config={"include_numbers": False, 'include_tip': True, 'include_ticks': False, 'tip_width': 0.1,
                                              'tip_height': 5}
